...
const VENDORS_DEFAULT = [
  ...
  { id: "v10", name: "Zachary Creasy", role: "Captive Demand", type: "internal" },
  { id: "v11", name: "Zachary Nippert", role: "Captive Demand", type: "internal" },
];
...
const SEED = [
  // ── Mantality Health ──────────────────────────────────────────
  { id: "c1", project: "p1", title: "Mantality Website Refresh", description: "Clean up the UX, call to actions, basic SEO, and modernize the website design.", suggestedBy: "v11", approvedBy: "v2", implementedBy: "v1", status: "implemented", category: "Design", dateSubmitted: "2025-11-21", dateImplemented: "2026-01-14", evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c2", project: "p1", title: "Add Bot Tracking Code", description: "Place tracking code in the website header to track site traffic and identify bot traffic sources.", suggestedBy: "v8", approvedBy: null, implementedBy: "v1", status: "implemented", category: "Analytics", dateSubmitted: "2026-01-14", dateImplemented: "2026-01-14", evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c3", project: "p1", title: "Form in Header", description: "Place the 'contact an expert' form physically in the header over the hero image.", suggestedBy: "v2", approvedBy: null, implementedBy: null, status: "suggested", category: "Design", dateSubmitted: "2026-01-15", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c4", project: "p1", title: "Update CTA Text", description: "Change the upper right hand corner button text to 'Book Your Appointment Now'.", suggestedBy: "v2", approvedBy: "v2", implementedBy: null, status: "approved", category: "Design", dateSubmitted: "2026-01-15", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c5", project: "p1", title: "Change SMS Checkbox Language", description: "Change the language on the SMS checkbox to an opt-out instead of opt-in.", suggestedBy: "v2", approvedBy: null, implementedBy: null, status: "suggested", category: "Design", dateSubmitted: "2026-01-15", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c6", project: "p1", title: "Block Bot Traffic ASNs", description: "Block the recommended ASNs at the firewall level to restrict bot traffic, excluding Amazon and Cloudflare.", suggestedBy: "v8", approvedBy: null, implementedBy: "v1", status: "implemented", category: "Performance", dateSubmitted: "2026-01-15", dateImplemented: "2026-02-01", evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c7", project: "p1", title: "Remove Form Intro Paragraph", description: "Remove the top introductory paragraph from the 'Speak with a Patient Coordinator' popup to improve the mobile experience.", suggestedBy: "v10", approvedBy: "v10", implementedBy: null, status: "approved", category: "Design", dateSubmitted: "2026-01-21", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "low" },
  { id: "c8", project: "p1", title: "Add IV Therapy to Services", description: "Add IV therapy to the services drop down menu.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "implemented", category: "Design", dateSubmitted: "2026-01-23", dateImplemented: "2026-01-23", evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c9", project: "p1", title: "Reorder Booking Form Locations", description: "Update the booking form to display a city location first instead of telemedicine.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "implemented", category: "Booking Flow", dateSubmitted: "2026-01-23", dateImplemented: "2026-01-23", evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c10", project: "p1", title: "Add Promotion Callout Sticky Bar", description: "Add a promotion callout banner for a specific demographic to the website.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "implemented", category: "Design", dateSubmitted: "2026-01-30", dateImplemented: "2026-02-02", evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c11", project: "p1", title: "Remove Sermorelin from Peptide Page", description: "Remove the word 'Sermorelin' from the Peptide Therapy Landing page.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "implemented", category: "Landing Pages", dateSubmitted: "2026-02-04", dateImplemented: "2026-02-04", evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c12", project: "p1", title: "Two-Step Booking Flow", description: "Implement a 2-step booking flow using a HubSpot form first, then embedding the Cal.com booking widget natively.", suggestedBy: "v10", approvedBy: "v10", implementedBy: "v1", status: "implemented", category: "Booking Flow", dateSubmitted: "2026-02-05", dateImplemented: "2026-02-11", evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c13", project: "p1", title: "Add No Show Policy", description: "Add the no show and late cancellation policy text directly under the booking form.", suggestedBy: "v2", approvedBy: null, implementedBy: null, status: "suggested", category: "Booking Flow", dateSubmitted: "2026-02-06", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "low" },
  { id: "c14", project: "p1", title: "Replace Gravity Forms with HubSpot Forms", description: "Replace existing Gravity Forms with native HubSpot forms across the website for better tracking alignment.", suggestedBy: "v7", approvedBy: "v7", implementedBy: null, status: "approved", category: "CRM / HubSpot", dateSubmitted: "2026-02-17", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c15", project: "p1", title: "Remove At-Home Testing Option", description: "Take off the at-home testing option and add the word 'available' to frictionless Telehealth callout.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "implemented", category: "Design", dateSubmitted: "2026-02-16", dateImplemented: "2026-02-16", evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c16", project: "p1", title: "Improve Book an Appointment Anchor Flow", description: "Add a pre-qualifier and context to the mid-page anchor jump to improve conversion.", suggestedBy: "v10", approvedBy: null, implementedBy: null, status: "suggested", category: "Booking Flow", dateSubmitted: "2026-02-25", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "medium" },
  // ── Agentis ───────────────────────────────────────────────────
  { id: "c17", project: "p2", title: "Agentis Website Overhaul", description: "Complete rebuild and redesign of the Agentis website.", suggestedBy: "v2", approvedBy: "v2", implementedBy: null, status: "approved", category: "Design", dateSubmitted: "2026-01-20", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "high" },
  // ── Arete ─────────────────────────────────────────────────────
  { id: "c18", project: "p3", title: "Update Arete HRT Landing Page CTA", description: "Replace 'Learn More' CTA with 'Book Now' linking directly to Hormone Therapy Consult + Health Score appointment type.", suggestedBy: "v3", approvedBy: "v3", implementedBy: "v1", status: "implemented", category: "Landing Pages", dateSubmitted: "2026-02-05", dateImplemented: "2026-02-10", evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c19", project: "p3", title: "New NAD Page Build", description: "Create a new NAD service page using language from the Arete site.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "implemented", category: "Landing Pages", dateSubmitted: "2026-02-06", dateImplemented: "2026-02-12", evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c20", project: "p3", title: "Google Analytics Dashboard Setup", description: "Set up a Google Analytics dashboard for the Arete website.", suggestedBy: "v2", approvedBy: "v2", implementedBy: null, status: "approved", category: "Analytics", dateSubmitted: "2026-02-06", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c21", project: "p3", title: "BioDesign Website Transition", description: "Transition and build for the BioDesign clinic website.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "in-progress", category: "Design", dateSubmitted: "2026-01-27", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c22", project: "p3", title: "Connect Arete to HubSpot", description: "Connect an Arete subdomain and email sending domain to HubSpot for landing pages and ad tracking.", suggestedBy: "v2", approvedBy: "v2", implementedBy: "v1", status: "in-progress", category: "CRM / HubSpot", dateSubmitted: "2026-02-23", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "high" },
  { id: "c23", project: "p3", title: "Install Google Tag Manager", description: "Install Google Tag Manager snippet on the Arete Wellness website.", suggestedBy: "v7", approvedBy: "v7", implementedBy: "v1", status: "implemented", category: "Analytics", dateSubmitted: "2026-02-23", dateImplemented: "2026-02-23", evidenceNote: "", conflictsWith: [], priority: "medium" },
  { id: "c24", project: "p3", title: "Update BLVD Code", description: "Change the measurement ID value in the hard coded head section to G-3NVGVMJ0EK.", suggestedBy: "v7", approvedBy: null, implementedBy: null, status: "suggested", category: "Analytics", dateSubmitted: "2026-02-24", dateImplemented: null, evidenceNote: "", conflictsWith: [], priority: "medium" },
];
...
export default function App() {
  ...
  // Refs so the cloud-load effect can read current state without stale closures.
  ...
  function saveToCloud(payload) {
    ...
    saveTimer.current = setTimeout(() => pushToCloud(payload), 1500);
  }

  // On mount: pull cloud data, hydrate state + localStorage cache.
  // If cloud is empty (first ever load after Blobs was wired up, or new
